...
class Development:
    ...
    DB_URI = "mongodb+srv://nezukoownwrhunterKAran:3E2ee8WAH7T5kwLk@nezukoownwrhunterkaran.nihsk.mongodb.net/?retryWrites=true&w=majority&appName=nezukoownwrhunterKAran"  # Your mongo DB URI
