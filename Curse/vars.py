...
class Development:
    ...
    DB_URI = "mongodb+srv://nezukoownwrhunterKAran:3E2ee8WAH7T5kwLk@nezukoownwrhunterkaran.nihsk.mongodb.net/mydatabase?retryWrites=true&w=majority&tls=true"  # Your mongo DB URI
