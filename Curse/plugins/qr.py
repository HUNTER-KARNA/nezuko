...
def qr_handler(client, message: Message):
    ...
    if len(command_text) > 1:
        ...
        message.reply_photo(qr_image, caption="Hᴇʀᴇ's ʏᴏᴜʀ QR Cᴏᴅᴇ")
    else:
        message.reply_text("Pʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴛʜᴇ ᴛᴇxᴛ ғᴏʀ ᴛʜᴇ QR ᴄᴏᴅᴇ ᴀғᴛᴇʀ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ. Exᴀᴍᴘʟᴇ ᴜsᴀɢᴇ: /qr ᴛᴇxᴛ")
